...
--     where MappedTypeID in (110, 7, 10, 5, 9)
    ...
    SELECT
      time_frame, timing.shiftID, filter_worker.PEGroupID, team.TeamName,
    ...
    group by time_frame, timing.shiftID, filter_worker.PEGroupID, team.TeamName,
...
ORDER BY time_frame desc, timing.shiftID desc, Office, TeamName, isNormalShift desc, ActivityType.TypeName
