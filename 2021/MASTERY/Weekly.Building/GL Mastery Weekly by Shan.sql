...
WITH Global_Imgs AS (
    ...
    WHERE dateadd(hour, 7, AssignDate) >= date_trunc('Week', getdate()) - INTERVAL '8 Weeks'
...
WHERE RejectedDatetime >= date_trunc('Week', getdate()) - INTERVAL '8 weeks'
...
WHERE img_count >=				
			CASE	
				...
				WHEN SawSkillID IN (6,11,47,434) THEN 15
