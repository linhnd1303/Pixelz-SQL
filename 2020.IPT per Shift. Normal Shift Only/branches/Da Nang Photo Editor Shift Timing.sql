/******************************************************************************************
** DAD Editor Normal Shift IPT&post last 3 month
...
** 3	2020-10-04	Linhnd		Insert easier acitivty type filter 
*******************************************************************************************/	
with _ as (
    select
...
WHERE
		filter_worker.PEGroupID 	in (4)				-- linhnd: 4 is Da Nang office
	and ActivityType.MappedTypeID 	in					-- linhnd: Filter Activity Type Here
									-- (1, -1, 1013)	: Breaking time
										(
											-- 110		,	--	1_IPT'
											-- 1		,	--	2_Break'
											-- 7		,	--	3_NoAssignedImage'
											...
											-- 7117	,	--	1__IPTAndPostProcessingWorkOnBrowser'
										)
